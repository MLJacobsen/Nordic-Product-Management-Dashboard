 ...
 *
 * Last updated: 2026-06-29 (valuation date: 2026-06-26)
 */
const luxNavData = {
  valuationDate: '2026-06-26',
  lastUpdated: '2026-06-29T12:48:00',
  ...
  funds: [
    {
      ...
      shareClasses: [
        { label: 'STB US PLUS LUX B ACC GBP', ccy: 'GBP', nav: 108.084, changePct: -0.0988, isin: 'LU3189754693', taCode: 'SRABE' },
    ...
    },
    {
      ...
      shareClasses: [
        ...
        { label: 'STB GL SOL B ACC EUR', ccy: 'EUR', nav: 201.749, changePct: -0.4266, isin: 'LU1932658476', taCode: 'SRAAK' },
    ...
    },
    {
      ...
      shareClasses: [
        { label: 'SKAGEN GL LUX A ACC EUR', ccy: 'EUR', nav: 149.624, changePct: 0.7746, isin: 'LU1932713917', taCode: 'SRAAF' },
        { label: 'SKAGEN GL LUX B ACC EUR', ccy: 'EUR', nav: 152.135, changePct: 0.7773, isin: 'LU1932715532', taCode: 'SRAAG' },
      ],
    },
    {
      ...
      shareClasses: [
        ...
        { label: 'STB GL PLS LUX B ACC GBP', ccy: 'GBP', nav: 213.360, changePct: -0.2381, isin: 'LU1932671149', taCode: 'SRAAQ' },
    ...
    },
    {
      ...
      shareClasses: [
        { label: 'SKAGEN KT LUX A ACC EUR', ccy: 'EUR', nav: 175.355, changePct: -1.784, isin: 'LU1932684985', taCode: 'SRAAA' },
        { label: 'SKAGEN KT LUX B ACC EUR', ccy: 'EUR', nav: 174.554, changePct: -1.7802, isin: 'LU1932686501', taCode: 'SRAAB' },
        { label: 'SKAGEN KT LUX I2 ACC EUR', ccy: 'EUR', nav: 14300.517, changePct: -1.7806, isin: 'LU2962150319', taCode: 'SRAAX' },
        { label: 'SKAGEN KT LUX B ACC GBP', ccy: 'GBP', nav: 150.342, changePct: -1.5757, isin: 'LU1932686766', taCode: 'SRAAC' },
      ],
    },
    {
      ...
      shareClasses: [
        ...
        { label: 'STB EM PLS LUX B GBP', ccy: 'GBP', nav: 181.183, changePct: -2.9653, isin: 'LU2658247064', taCode: 'SRAAS' },
        { label: 'STB EM PLS LUX H1 GBP', ccy: 'GBP', nav: 181.328, changePct: -2.9651, isin: 'LU2658246413', taCode: 'SRAAT' },
