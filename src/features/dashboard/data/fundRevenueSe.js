 ...
 */
export const revenueSeDataDate = '2026-07-31';
...
const fundRevenueSe = [
  ...
  { fundId: 'SPPPEM', name: 'Storebrand Kortränta', aumMillSek: 22542, terPct: 0.21 },
  ...
  { fundId: 'SPPFOB', name: 'Storebrand FRN Företagsobligation', aumMillSek: 19601, terPct: 0.41 },
  ...
  { fundId: 'SPPGRO', name: 'Storebrand Grön Obligation', aumMillSek: 12808, terPct: 0.31 },
  ...
  { fundId: 'SPPHIY', name: 'Storebrand High Yield Företagsobligation', aumMillSek: 9625, terPct: 0.51 },
  ...
  { fundId: 'SPPBOL', name: 'Storebrand Sverige Småbolag Plus', aumMillSek: 3510, terPct: 0.52 },
  { fundId: 'SPP40', name: 'SPP Generation 40-tal', aumMillSek: 3148, terPct: 0.41 },
  { fundId: 'SPPGOD', name: 'GodFond Sverige & Världen', aumMillSek: 2605, terPct: 0.87 },
