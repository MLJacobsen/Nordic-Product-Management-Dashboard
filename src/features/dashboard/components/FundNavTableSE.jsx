...
import mockFundsSE from '../data/mockFundsSE';
...
function FundNavTableSE() {
  ...
  if (loading) {
    return (
      <div className="animate-pulse space-y-2" data-testid="fund-nav-se-loading">
        {[...Array(5)].map((_, i) => (
  ...
  return (
    <div data-testid="fund-nav-table-se">
      <h3 className="text-lg font-semibold text-neutral-800 mb-3">Fund NAV - SE Domiciled Funds</h3>
